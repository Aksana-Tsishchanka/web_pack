...
/***/ function(module, exports, __webpack_require__) {
	...
	var url = 'https://api.nytimes.com/svc/topstories/v2/travel.json?api-key=36379cbe64354a0e99d3a44d18aa101a';
	var init = {
	  method: 'GET',
	  url: url
	};
	var imageType = 'mediumThreeByTwo210';
	...
	function addSections(json) {
	  ...
	  var arrSections = json.results;
	  var copyright = json.copyright;

	  document.body.innerHTML = '<header>\n                               <h1>The New York Times News</h1>\n                               <h3>' + section + '</h3></header>\n                               <div class=\'flexbox-container\'>\n                               ' + arrSections.reduce(function (result, el) {
	    return result + createSection(el);
